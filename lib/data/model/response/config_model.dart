class ConfigModel {
  ...
  ConfigModel({int systemDefaultCurrency, String currencySymbolPosition, bool maintenanceMode, bool digitalPayment, BaseUrls baseUrls,
    StaticUrls staticUrls, List<CurrencyList> currencyList, Language language}) {
