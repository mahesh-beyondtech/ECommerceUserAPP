          ...
          child: Consumer<ProductDetailsProvider>(
            builder: (context, details, child) {
              bool _existInCart = Provider.of<CartProvider>(context)
                  .isAddedInCart(product.id, product.colors.length > 0 ? product.colors[details.variantIndex].name : '');
              ...
              return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                // Cart button
                CustomButton(
                  buttonText: getTranslated(_stock < 1 ? 'out_of_stock' : isBuy ? 'buy_now' : _existInCart
                      ? 'added_in_cart' : 'add_to_cart', context),
                  onTap: (_stock < 1 || _existInCart) ? null : () {
                    if(_stock > 0 && !_existInCart) {
                      CartModel _cartModel = CartModel(
                        ...
                        product.colors.length > 0 ? product.colors[details.variantIndex].name : '',
