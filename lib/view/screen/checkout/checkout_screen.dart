                  ...
                  onPressed: () async {
                    if(Provider.of<OrderProvider>(context, listen: false).addressIndex == null) {
                      ...
                      for(int index=0; index < widget.cartList.length; index++) {
                        ...
                        carts.add(Cart(
                          cart.id.toString(), PriceConverter.calculation(cart.price, cart.tax, cart.taxType, 1), cart.quantity, cart.price,
                          PriceConverter.calculation(cart.price, cart.discount, cart.discountType, 1), 'amount',
                          index == 0 ? Provider.of<OrderProvider>(context, listen: false).shippingList[Provider.of<OrderProvider>(context, listen: false)
                              .shippingIndex].id : 1, cart.variation != null ? cart.variation.type : '', cart.variation != null ? [cart.variation] : [], index == 0 ? _shippingCost : 0,
                        ));
                      }
